    ...
    <div style="padding: 0px 5px 0 5px;">
        <table border="1px" style="font-size: 10px;border: 1px solid black; width: 100%;border-collapse: collapse;text-align: center;" class="f12">
            <tr>
                ...
                <th style="border: 1px solid #000; padding: 5px;">Kode Suplier</th>
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 5px;"><?=$data->kode?></td>
                <td style="border: 1px solid #000; padding: 5px;"><?=$data->nama?></td>
                <td style="border: 1px solid #000; padding: 5px;"><?=$data->alamat?></td>
                <td style="border: 1px solid #000; padding: 5px;"><?=$data->email?></td>
                <td style="border: 1px solid #000; padding: 5px;"><?=$data->hp?></td>
            </tr>
            <?php } ?>
        </table>
        <br>
